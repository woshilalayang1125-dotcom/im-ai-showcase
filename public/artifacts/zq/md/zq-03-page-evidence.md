...
**证据索引**
| claim_id | claim | value | source_type | source_detail | calculation_logic | confidence | visible_or_notes |
|---|---|---|---|---|---|---|---|
```
...
**证据口径**
- `P&L forecast_2026.xlsx`, sheet `P&L forecast`。
- `2026 pipeline.xlsx`, pipeline 明细与总计。
- 若使用 2024A，必须来自 `Datapack_Zixel.xlsx`, sheet `4. 运营数据`，确认收入 2,234.9 万元，不使用无来源 2024 财务数据。
